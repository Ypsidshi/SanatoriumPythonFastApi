...
SERVICE_CATALOG = [
    {
        "base": "Массаж",
        "variants": ["спины", "шеи", "ног", "классический", "точечный", "лимфо"],
        "price": (900, 1800),
        "durations": [30, 45, 60],
    },
    {
        "base": "Сауна",
        "variants": ["финская", "кедровая", "инфра", "арома"],
        "price": (700, 1400),
        "durations": [30, 60, 90],
    },
    {
        "base": "СПА-уход",
        "variants": ["лицо", "тело", "антистресс"],
        "price": (1200, 2500),
        "durations": [40, 60, 90],
    },
    {
        "base": "Грязелечение",
        "variants": ["аппликации", "обертывание"],
        "price": (1000, 2000),
        "durations": [20, 30, 40],
    },
    {
        "base": "Ингаляции",
        "variants": ["травы", "минеральные", "солевые"],
        "price": (500, 900),
        "durations": [10, 15, 20],
    },
    ...
    {
        "base": "Физиотерапия",
        "variants": ["магнит", "ультразвук", "лазер"],
        "price": (700, 1600),
        "durations": [15, 20, 30],
    },
    {
        "base": "Косметология",
        "variants": ["уход", "маска", "пилинг"],
        "price": (900, 2000),
        "durations": [30, 45, 60],
    },
    {
        "base": "Соляная комната",
        "variants": ["сеанс", "дети", "релакс"],
        "price": (600, 1200),
        "durations": [30, 45],
    },
