...
class Administrator(Base):
    ...
    pansionats = relationship("Pansionat", back_populates="administrator")
...
class Pansionat(Base):
    ...
    administrator = relationship("Administrator", back_populates="pansionats")
    health_profile = relationship("HealthProfile", back_populates="pansionats")
    rooms = relationship("Room", back_populates="pansionat")
    residents = relationship("Resident", back_populates="pansionat")
...
class Resident(Base):
    ...
    pansionat = relationship("Pansionat", back_populates="residents")
...
class Contract(Base):
    ...
    id_dogovor = Column(Integer, primary_key=True, autoincrement=True)
